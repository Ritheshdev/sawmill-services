   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <span>email :</span>
            <input type="email" name="email" value="<?= $fetch_profile['email']; ?>" placeholder="update email" readonly class="box">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="new_pass" id="pass" onblur="validatePass()" placeholder="enter new password" class="box">
